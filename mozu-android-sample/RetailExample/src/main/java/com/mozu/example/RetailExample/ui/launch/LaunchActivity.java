package com.mozu.example.RetailExample.ui.launch;
...
import com.mozu.example.RetailExample.ui.signin.SignInActivity;
    ...
    private void authenticateApplication() {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                try
                {
                    AppAuthenticator.initialize(appAuthInfo, "http://home.mozu.com");
                    pd.dismiss();
                    checkIfLoggedIn();
                }
