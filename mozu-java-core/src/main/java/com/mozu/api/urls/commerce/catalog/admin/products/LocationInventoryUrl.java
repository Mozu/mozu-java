...
public class LocationInventoryUrl
{
	 ...
	 */
	public static MozuUrl getLocationInventoriesUrl(String fields, String filter, Integer pageSize, String productCode, String sortBy, Integer startIndex)
	{
		UrlFormatter formatter = new UrlFormatter("/api/commerce/catalog/admin/products/{ProductCode}/LocationInventory/?startIndex={startIndex}&pageSize={pageSize}&sortBy={sortBy}&filter={filter}&fields={fields}");
	 ...
	 * @return   String Resource Url
	 */
	public static MozuUrl getLocationInventoryUrl(String fields, String locationCode, String productCode)
	{
		UrlFormatter formatter = new UrlFormatter("/api/commerce/catalog/admin/products/{ProductCode}/LocationInventory/{LocationCode}?fields={fields}");
		formatter.formatUrl("fields", fields);
