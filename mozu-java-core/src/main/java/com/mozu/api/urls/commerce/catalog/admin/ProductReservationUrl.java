...
public class ProductReservationUrl
{
	 ...
	 */
	public static MozuUrl getProductReservationsUrl(String fields, String filter, Integer pageSize, String sortBy, Integer startIndex)
	{
		UrlFormatter formatter = new UrlFormatter("/api/commerce/catalog/admin/productreservations/?startIndex={startIndex}&pageSize={pageSize}&sortBy={sortBy}&filter={filter}&fields={fields}");
	 ...
	 * @return   String Resource Url
	 */
	public static MozuUrl getProductReservationUrl(String fields, Integer productReservationId)
	{
		UrlFormatter formatter = new UrlFormatter("/api/commerce/catalog/admin/productreservations/{productReservationId}?fields={fields}");
		formatter.formatUrl("fields", fields);
