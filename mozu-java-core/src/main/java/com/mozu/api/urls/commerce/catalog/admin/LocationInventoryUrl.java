...
public class LocationInventoryUrl
{
	...
	{
		UrlFormatter formatter = new UrlFormatter("/api/commerce/catalog/admin/locationinventory/{locationCode}/{productCode}?fields={fields}");
	 ...
	 * @return   String Resource Url
	 */
	public static MozuUrl getLocationInventoriesUrl(String fields, String filter, String locationCode, Integer pageSize, String sortBy, Integer startIndex)
	{
		UrlFormatter formatter = new UrlFormatter("/api/commerce/catalog/admin/locationinventory/{locationCode}?startIndex={startIndex}&pageSize={pageSize}&sortBy={sortBy}&filter={filter}&fields={fields}");
		formatter.formatUrl("fields", fields);
