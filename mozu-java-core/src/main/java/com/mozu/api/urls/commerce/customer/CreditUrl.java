...
public class CreditUrl
{
	 ...
	 */
	public static MozuUrl getCreditsUrl(String filter, Integer pageSize, String sortBy, Integer startIndex)
	{
		UrlFormatter formatter = new UrlFormatter("/api/commerce/customer/credits/?startIndex={startIndex}&pageSize={pageSize}&sortBy={sortBy}&filter={filter}");
	...
	{
		UrlFormatter formatter = new UrlFormatter("/api/commerce/customer/credits/");
		return new MozuUrl(formatter.getResourceUrl(), MozuUrl.UrlLocation.TENANT_POD) ;
	}
