...
public class CreditAuditEntryResource {
	 ...
	 * <p><pre><code>
	 *	CreditAuditEntry creditauditentry = new CreditAuditEntry();
	 *	CreditAuditEntryCollection creditAuditEntryCollection = creditauditentry.GetAuditEntries( code,  startIndex,  pageSize,  sortBy,  filter);
	 * </code></pre></p>
	 * @param code User-defined code of the credit for which to retrieve audit entries.
	 ...
	 * @see com.mozu.api.contracts.customer.credit.CreditAuditEntryCollection
	 */
	public com.mozu.api.contracts.customer.credit.CreditAuditEntryCollection getAuditEntries(String code, Integer startIndex, Integer pageSize, String sortBy, String filter) throws Exception
	{
		MozuClient<com.mozu.api.contracts.customer.credit.CreditAuditEntryCollection> client = com.mozu.api.clients.commerce.customer.credits.CreditAuditEntryClient.getAuditEntriesClient( code,  startIndex,  pageSize,  sortBy,  filter);
