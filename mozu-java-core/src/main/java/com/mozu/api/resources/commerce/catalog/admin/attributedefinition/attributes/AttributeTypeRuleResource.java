...
public class AttributeTypeRuleResource {
	...
	public AttributeTypeRuleResource(ApiContext apiContext, DataViewMode dataViewMode) 
	{
		_apiContext = apiContext;
	 ...
	 *	AttributeTypeRuleCollection attributeTypeRuleCollection = attributetyperule.GetAttributeTypeRules(_dataViewMode);
	 * </code></pre></p>
	 ...
	 * <p><pre><code>
	 *	AttributeTypeRule attributetyperule = new AttributeTypeRule();
	 *	AttributeTypeRuleCollection attributeTypeRuleCollection = attributetyperule.GetAttributeTypeRules(_dataViewMode,  startIndex,  pageSize,  sortBy,  filter,  responseFields);
	 * </code></pre></p>
	...
	{
		MozuClient<com.mozu.api.contracts.productadmin.AttributeTypeRuleCollection> client = com.mozu.api.clients.commerce.catalog.admin.attributedefinition.attributes.AttributeTypeRuleClient.getAttributeTypeRulesClient(_dataViewMode,  startIndex,  pageSize,  sortBy,  filter,  responseFields);
