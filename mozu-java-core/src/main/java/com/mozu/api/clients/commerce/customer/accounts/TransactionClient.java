...
public class TransactionClient {
	 ...
	 * 
	 * <p><pre><code>
	 * MozuClient<java.io.InputStream> mozuClient=RemoveTransactionClient( accountId,  transactionId);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 ...
	 * @see Stream
	 */
	public static MozuClient<java.io.InputStream> removeTransactionClient(Integer accountId, String transactionId) throws Exception
	{
