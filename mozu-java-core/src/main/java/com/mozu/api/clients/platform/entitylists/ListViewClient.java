...
public class ListViewClient {
	...
	{
		MozuUrl url = com.mozu.api.urls.platform.entitylists.ListViewUrl.getEntityListViewsUrl(entityListFullName);
		String verb = "GET";
		Class<?> clz = com.mozu.api.contracts.mzdb.ListViewCollection.class;
		MozuClient<com.mozu.api.contracts.mzdb.ListViewCollection> mozuClient = new MozuClient(clz);
	...
	{
		MozuUrl url = com.mozu.api.urls.platform.entitylists.ListViewUrl.getEntityListViewUrl(entityListFullName, viewName);
		String verb = "GET";
		Class<?> clz = com.mozu.api.contracts.mzdb.ListView.class;
		MozuClient<com.mozu.api.contracts.mzdb.ListView> mozuClient = new MozuClient(clz);
		mozuClient.setVerb(verb);
		mozuClient.setResourceUrl(url);
		return mozuClient;
	...
	{
		MozuUrl url = com.mozu.api.urls.platform.entitylists.ListViewUrl.getViewEntityUrl(entityId, entityListFullName, viewName);
		String verb = "GET";
	...
	{
		return getViewEntitiesClient( entityListFullName,  viewName,  null,  null,  null);
	}

	/**
	 * 
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.mzdb.EntityCollection> mozuClient=GetViewEntitiesClient( entityListFullName,  viewName,  pageSize,  startIndex,  filter);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 * EntityCollection entityCollection = client.Result();
	 * </code></pre></p>
	 ...
	 * @see com.mozu.api.contracts.mzdb.EntityCollection
	 */
	public static MozuClient<com.mozu.api.contracts.mzdb.EntityCollection> getViewEntitiesClient(String entityListFullName, String viewName, Integer pageSize, Integer startIndex, String filter) throws Exception
	{
		MozuUrl url = com.mozu.api.urls.platform.entitylists.ListViewUrl.getViewEntitiesUrl(entityListFullName, filter, pageSize, startIndex, viewName);
		String verb = "GET";
	...
	{
		MozuUrl url = com.mozu.api.urls.platform.entitylists.ListViewUrl.getViewEntityContainerUrl(entityId, entityListFullName, viewName);
		String verb = "GET";
	...
	{
		return getViewEntityContainersClient( entityListFullName,  viewName,  null,  null,  null);
	}

	/**
	 * 
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.mzdb.EntityContainerCollection> mozuClient=GetViewEntityContainersClient( entityListFullName,  viewName,  pageSize,  startIndex,  filter);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 * EntityContainerCollection entityContainerCollection = client.Result();
	 * </code></pre></p>
	 ...
	 * @see com.mozu.api.contracts.mzdb.EntityContainerCollection
	 */
	public static MozuClient<com.mozu.api.contracts.mzdb.EntityContainerCollection> getViewEntityContainersClient(String entityListFullName, String viewName, Integer pageSize, Integer startIndex, String filter) throws Exception
	{
		MozuUrl url = com.mozu.api.urls.platform.entitylists.ListViewUrl.getViewEntityContainersUrl(entityListFullName, filter, pageSize, startIndex, viewName);
		String verb = "GET";
	...
	{
		MozuUrl url = com.mozu.api.urls.platform.entitylists.ListViewUrl.createEntityListViewUrl(entityListFullName);
		String verb = "POST";
		Class<?> clz = com.mozu.api.contracts.mzdb.ListView.class;
		MozuClient<com.mozu.api.contracts.mzdb.ListView> mozuClient = new MozuClient(clz);
		mozuClient.setVerb(verb);
	...
	{
		MozuUrl url = com.mozu.api.urls.platform.entitylists.ListViewUrl.updateEntityListViewUrl(entityListFullName, viewName);
		String verb = "PUT";
		Class<?> clz = com.mozu.api.contracts.mzdb.ListView.class;
		MozuClient<com.mozu.api.contracts.mzdb.ListView> mozuClient = new MozuClient(clz);
		mozuClient.setVerb(verb);
