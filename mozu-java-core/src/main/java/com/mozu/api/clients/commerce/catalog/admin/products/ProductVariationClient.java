...
public class ProductVariationClient {
	 ...
	 * Retrieves the details of a product variation based on the supplied product code and variation key.
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.productadmin.ProductVariation> mozuClient=GetProductVariationClient(dataViewMode,  productCode,  variationKey,  fields);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 * ProductVariation productVariation = client.Result();
	 * </code></pre></p>
	 ...
	 * @see com.mozu.api.contracts.productadmin.ProductVariation
	 */
	public static MozuClient<com.mozu.api.contracts.productadmin.ProductVariation> getProductVariationClient(com.mozu.api.DataViewMode dataViewMode, String productCode, String variationKey, String fields) throws Exception
	{
		MozuUrl url = com.mozu.api.urls.commerce.catalog.admin.products.ProductVariationUrl.getProductVariationUrl(fields, productCode, variationKey);
		String verb = "GET";
	 ...
	 * Retrieves a list of the product variations configured for the specified product code.
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.productadmin.ProductVariationPagedCollection> mozuClient=GetProductVariationsClient(dataViewMode,  productCode,  startIndex,  pageSize,  sortBy,  filter,  fields);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 * ProductVariationPagedCollection productVariationPagedCollection = client.Result();
	 * </code></pre></p>
	 ...
	 * @see com.mozu.api.contracts.productadmin.ProductVariationPagedCollection
	 */
	public static MozuClient<com.mozu.api.contracts.productadmin.ProductVariationPagedCollection> getProductVariationsClient(com.mozu.api.DataViewMode dataViewMode, String productCode, Integer startIndex, Integer pageSize, String sortBy, String filter, String fields) throws Exception
	{
		MozuUrl url = com.mozu.api.urls.commerce.catalog.admin.products.ProductVariationUrl.getProductVariationsUrl(fields, filter, pageSize, productCode, sortBy, startIndex);
		String verb = "GET";
	 ...
	 * Modifies the details of a variation, based on the supplied variation key, for the specified product code.
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.productadmin.ProductVariation> mozuClient=UpdateProductVariationClient(dataViewMode,  productVariation,  productCode,  variationKey,  fields);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 * ProductVariation productVariation = client.Result();
	 * </code></pre></p>
	 ...
	 * @see com.mozu.api.contracts.productadmin.ProductVariation
	 */
	public static MozuClient<com.mozu.api.contracts.productadmin.ProductVariation> updateProductVariationClient(com.mozu.api.DataViewMode dataViewMode, com.mozu.api.contracts.productadmin.ProductVariation productVariation, String productCode, String variationKey, String fields) throws Exception
	{
		MozuUrl url = com.mozu.api.urls.commerce.catalog.admin.products.ProductVariationUrl.updateProductVariationUrl(fields, productCode, variationKey);
		String verb = "PUT";
		Class<?> clz = com.mozu.api.contracts.productadmin.ProductVariation.class;
		MozuClient<com.mozu.api.contracts.productadmin.ProductVariation> mozuClient = new MozuClient(clz);
		mozuClient.setVerb(verb);
	 ...
	 * Modifies the collection of variations for the specified product code. Because this PUT replaces the existing resource, supply all information necessary to maintain for the product variation.
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.productadmin.ProductVariationCollection> mozuClient=UpdateProductVariationsClient(dataViewMode,  productVariations,  productCode,  fields);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 * ProductVariationCollection productVariationCollection = client.Result();
	 * </code></pre></p>
	 ...
	 * @see com.mozu.api.contracts.productadmin.ProductVariationCollection
	 */
	public static MozuClient<com.mozu.api.contracts.productadmin.ProductVariationCollection> updateProductVariationsClient(com.mozu.api.DataViewMode dataViewMode, com.mozu.api.contracts.productadmin.ProductVariationCollection productVariations, String productCode, String fields) throws Exception
	{
		MozuUrl url = com.mozu.api.urls.commerce.catalog.admin.products.ProductVariationUrl.updateProductVariationsUrl(fields, productCode);
		String verb = "PUT";
