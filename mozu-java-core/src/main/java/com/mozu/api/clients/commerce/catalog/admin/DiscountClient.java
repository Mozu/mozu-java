...
public class DiscountClient {
	 ...
	 * 
	 * <p><pre><code>
	 * MozuClient<java.io.InputStream> mozuClient=DeleteDiscountClient( discountId);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 ...
	 * @see Stream
	 */
	public static MozuClient<java.io.InputStream> deleteDiscountClient(Integer discountId) throws Exception
	{
