...
public class BillingInfoClient {
	 ...
	 * Retrieves the billing information associated with an order.
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.commerceruntime.payments.BillingInfo> mozuClient=GetBillingInfoClient( orderId,  draft);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 * BillingInfo billingInfo = client.Result();
	 * </code></pre></p>
	 ...
	 * @see com.mozu.api.contracts.commerceruntime.payments.BillingInfo
	 */
	public static MozuClient<com.mozu.api.contracts.commerceruntime.payments.BillingInfo> getBillingInfoClient(String orderId, Boolean draft) throws Exception
	{
	 ...
	 * Updates the billing information supplied for an order.
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.commerceruntime.payments.BillingInfo> mozuClient=SetBillingInfoClient( billingInfo,  orderId,  updateMode,  version);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 * BillingInfo billingInfo = client.Result();
	 * </code></pre></p>
	 ...
	 * @see com.mozu.api.contracts.commerceruntime.payments.BillingInfo
	 */
	public static MozuClient<com.mozu.api.contracts.commerceruntime.payments.BillingInfo> setBillingInfoClient(com.mozu.api.contracts.commerceruntime.payments.BillingInfo billingInfo, String orderId, String updateMode, String version) throws Exception
	{
