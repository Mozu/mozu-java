...
public class CreditAuditEntryClient {
	 ...
	 * Retrieves the list of audit entries for the credit, according to any filter or sort criteria specified in the request.
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.customer.credit.CreditAuditEntryCollection> mozuClient=GetAuditEntriesClient( code,  startIndex,  pageSize,  sortBy,  filter);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 * CreditAuditEntryCollection creditAuditEntryCollection = client.Result();
	 * </code></pre></p>
	 ...
	 * @see com.mozu.api.contracts.customer.credit.CreditAuditEntryCollection
	 */
	public static MozuClient<com.mozu.api.contracts.customer.credit.CreditAuditEntryCollection> getAuditEntriesClient(String code, Integer startIndex, Integer pageSize, String sortBy, String filter) throws Exception
	{
		MozuUrl url = com.mozu.api.urls.commerce.customer.credits.CreditAuditEntryUrl.getAuditEntriesUrl(code, filter, pageSize, sortBy, startIndex);
		String verb = "GET";
		Class<?> clz = com.mozu.api.contracts.customer.credit.CreditAuditEntryCollection.class;
		MozuClient<com.mozu.api.contracts.customer.credit.CreditAuditEntryCollection> mozuClient = new MozuClient(clz);
