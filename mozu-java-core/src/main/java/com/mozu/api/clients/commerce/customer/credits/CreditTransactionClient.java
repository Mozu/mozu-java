...
public class CreditTransactionClient {
	 ...
	 * Retrieves a list of the transactions performed using a customer credit that update the balance of the credit.
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.customer.credit.CreditTransactionCollection> mozuClient=GetTransactionsClient( code,  startIndex,  pageSize,  sortBy,  filter);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 * CreditTransactionCollection creditTransactionCollection = client.Result();
	 * </code></pre></p>
	 ...
	 * @see com.mozu.api.contracts.customer.credit.CreditTransactionCollection
	 */
	public static MozuClient<com.mozu.api.contracts.customer.credit.CreditTransactionCollection> getTransactionsClient(String code, Integer startIndex, Integer pageSize, String sortBy, String filter) throws Exception
	{
