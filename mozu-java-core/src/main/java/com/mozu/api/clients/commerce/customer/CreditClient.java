...
public class CreditClient {
	 ...
	 * Retrieves a list of store credits applied to customer accounts, according any filter and sort criteria specified in the request.
	 * <p><pre><code>
	 * MozuClient<com.mozu.api.contracts.customer.credit.CreditCollection> mozuClient=GetCreditsClient( startIndex,  pageSize,  sortBy,  filter);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 * CreditCollection creditCollection = client.Result();
	 * </code></pre></p>
	 ...
	 * @see com.mozu.api.contracts.customer.credit.CreditCollection
	 */
	public static MozuClient<com.mozu.api.contracts.customer.credit.CreditCollection> getCreditsClient(Integer startIndex, Integer pageSize, String sortBy, String filter) throws Exception
	{
		MozuUrl url = com.mozu.api.urls.commerce.customer.CreditUrl.getCreditsUrl(filter, pageSize, sortBy, startIndex);
		String verb = "GET";
	...
	{
		MozuUrl url = com.mozu.api.urls.commerce.customer.CreditUrl.getCreditUrl(code);
		String verb = "GET";
	...
	{
		MozuUrl url = com.mozu.api.urls.commerce.customer.CreditUrl.addCreditUrl();
		String verb = "POST";
		Class<?> clz = com.mozu.api.contracts.customer.credit.Credit.class;
		MozuClient<com.mozu.api.contracts.customer.credit.Credit> mozuClient = new MozuClient(clz);
		mozuClient.setVerb(verb);
	...
	{
		MozuUrl url = com.mozu.api.urls.commerce.customer.CreditUrl.updateCreditUrl(code);
		String verb = "PUT";
		Class<?> clz = com.mozu.api.contracts.customer.credit.Credit.class;
		MozuClient<com.mozu.api.contracts.customer.credit.Credit> mozuClient = new MozuClient(clz);
		mozuClient.setVerb(verb);
