...
import com.mozu.api.contracts.event.EventDeliverySummary;
...
public class EventDeliverySummaryCollection implements Serializable
{
	 ...
	 */
	protected List<EventDeliverySummary> items;
	public List<EventDeliverySummary> getItems() {
		return this.items;
	}
	public void setItems(List<EventDeliverySummary> items) {
		this.items = items;
	}
