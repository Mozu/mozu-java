...
public class CustomerPurchaseOrderAccountFactory
{
	...
	public static java.io.InputStream deleteCustomerPurchaseOrderAccount(ApiContext apiContext, Integer accountId, int expectedCode) throws Exception
	{
		java.io.InputStream returnObj;
		CustomerPurchaseOrderAccountResource resource = new CustomerPurchaseOrderAccountResource(apiContext);
		try
		{
			returnObj = resource.deleteCustomerPurchaseOrderAccount( accountId);
		}
		catch (ApiException e)
		{
			if(e.getHttpStatusCode() != expectedCode)
