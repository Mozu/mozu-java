...
*/
package com.mozu.test.framework.datafactory.commerce.wishlists;
...
public class WishlistItemFactory
{
	...
	public static java.io.InputStream deleteWishlistItem(ApiContext apiContext, String wishlistId, String wishlistItemId, int expectedCode) throws Exception
	{
		java.io.InputStream returnObj;
		WishlistItemResource resource = new WishlistItemResource(apiContext);
		try
		{
			returnObj = resource.deleteWishlistItem( wishlistId,  wishlistItemId);
		}
		catch (ApiException e)
		{
			if(e.getHttpStatusCode() != expectedCode)
