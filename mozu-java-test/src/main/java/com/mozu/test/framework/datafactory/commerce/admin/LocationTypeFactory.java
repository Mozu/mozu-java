...
public class LocationTypeFactory
{
	...
	public static java.io.InputStream deleteLocationType(ApiContext apiContext, String locationTypeCode, int expectedCode) throws Exception
	{
		java.io.InputStream returnObj;
		LocationTypeResource resource = new LocationTypeResource(apiContext);
		try
		{
			returnObj = resource.deleteLocationType( locationTypeCode);
		}
		catch (ApiException e)
		{
			if(e.getHttpStatusCode() != expectedCode)
