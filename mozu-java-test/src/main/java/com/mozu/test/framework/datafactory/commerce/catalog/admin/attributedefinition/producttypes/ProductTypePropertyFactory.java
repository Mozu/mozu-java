...
public class ProductTypePropertyFactory
{
	...
	public static java.io.InputStream deleteProperty(ApiContext apiContext, com.mozu.api.DataViewMode dataViewMode, Integer productTypeId, String attributeFQN, int expectedCode) throws Exception
	{
		java.io.InputStream returnObj;
		ProductTypePropertyResource resource = new ProductTypePropertyResource(apiContext, dataViewMode);
		try
		{
			returnObj = resource.deleteProperty( productTypeId,  attributeFQN);
		}
		catch (ApiException e)
		{
			if(e.getHttpStatusCode() != expectedCode)
