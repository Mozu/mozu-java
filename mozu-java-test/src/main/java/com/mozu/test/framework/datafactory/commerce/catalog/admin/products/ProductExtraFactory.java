...
public class ProductExtraFactory
{
	...
	public static java.io.InputStream deleteExtra(ApiContext apiContext, com.mozu.api.DataViewMode dataViewMode, String productCode, String attributeFQN, int expectedCode) throws Exception
	{
		java.io.InputStream returnObj;
		ProductExtraResource resource = new ProductExtraResource(apiContext, dataViewMode);
		try
		{
			returnObj = resource.deleteExtra( productCode,  attributeFQN);
		}
		catch (ApiException e)
		{
			if(e.getHttpStatusCode() != expectedCode)
	...
	public static java.io.InputStream deleteExtraValueLocalizedDeltaPrice(ApiContext apiContext, com.mozu.api.DataViewMode dataViewMode, String productCode, String attributeFQN, String value, String currencyCode, int expectedCode) throws Exception
	{
		java.io.InputStream returnObj;
		ProductExtraResource resource = new ProductExtraResource(apiContext, dataViewMode);
		try
		{
			returnObj = resource.deleteExtraValueLocalizedDeltaPrice( productCode,  attributeFQN,  value,  currencyCode);
		}
		catch (ApiException e)
		{
			if(e.getHttpStatusCode() != expectedCode)
