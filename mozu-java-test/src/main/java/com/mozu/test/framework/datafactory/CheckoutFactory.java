...
public class CheckoutFactory
{
	...
	public static List<com.mozu.api.contracts.commerceruntime.checkouts.CheckoutGroupRates> getAvailableShipmentMethods(ApiContext apiContext, String checkoutId, int expectedCode) throws Exception
	{
		...
		try
		{
			returnObj = resource.getAvailableShipmentMethods( checkoutId);
		}
		catch (ApiException e)
		{
			if(e.getHttpStatusCode() != expectedCode)
