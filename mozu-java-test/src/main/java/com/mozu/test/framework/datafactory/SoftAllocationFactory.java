...
public class SoftAllocationFactory
{
	...
	public static com.mozu.api.contracts.productadmin.SoftAllocationCollection getSoftAllocations(ApiContext apiContext, int expectedCode, int successCode) throws Exception
	{
		return getSoftAllocations(apiContext,  null,  null,  null,  null,  null, expectedCode, successCode );
	}

	public static com.mozu.api.contracts.productadmin.SoftAllocationCollection getSoftAllocations(ApiContext apiContext, Integer startIndex, Integer pageSize, String sortBy, String filter, String responseFields, int expectedCode, int successCode) throws Exception
	{
	...
	public static com.mozu.api.contracts.productadmin.SoftAllocation getSoftAllocation(ApiContext apiContext, Integer softAllocationId, int expectedCode, int successCode) throws Exception
	{
		return getSoftAllocation(apiContext,  softAllocationId,  null, expectedCode, successCode );
	}

	public static com.mozu.api.contracts.productadmin.SoftAllocation getSoftAllocation(ApiContext apiContext, Integer softAllocationId, String responseFields, int expectedCode, int successCode) throws Exception
	{
	...
	public static List<com.mozu.api.contracts.productadmin.SoftAllocation> addSoftAllocations(ApiContext apiContext, List<com.mozu.api.contracts.productadmin.SoftAllocation> softAllocationsIn, int expectedCode, int successCode) throws Exception
	{
	...
	public static List<com.mozu.api.contracts.productadmin.ProductReservation> convertToProductReservation(ApiContext apiContext, List<com.mozu.api.contracts.productadmin.SoftAllocation> softAllocations, int expectedCode, int successCode) throws Exception
	{
	...
	public static void deleteSoftAllocation(ApiContext apiContext, Integer softAllocationId, int expectedCode, int successCode) throws Exception
	{
		SoftAllocationResource resource = new SoftAllocationResource(apiContext);
		try
		{
