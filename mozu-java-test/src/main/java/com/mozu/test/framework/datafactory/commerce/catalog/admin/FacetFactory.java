...
public class FacetFactory
{
	...
	public static java.io.InputStream deleteFacetById(ApiContext apiContext, Integer facetId, int expectedCode) throws Exception
	{
		java.io.InputStream returnObj;
		FacetResource resource = new FacetResource(apiContext);
		try
		{
			returnObj = resource.deleteFacetById( facetId);
		}
		catch (ApiException e)
		{
			if(e.getHttpStatusCode() != expectedCode)
