...
public class ProductOptionFactory
{
	...
	public static java.io.InputStream deleteOption(ApiContext apiContext, com.mozu.api.DataViewMode dataViewMode, String productCode, String attributeFQN, int expectedCode) throws Exception
	{
		java.io.InputStream returnObj;
		ProductOptionResource resource = new ProductOptionResource(apiContext, dataViewMode);
		try
		{
			returnObj = resource.deleteOption( productCode,  attributeFQN);
		}
		catch (ApiException e)
		{
			if(e.getHttpStatusCode() != expectedCode)
