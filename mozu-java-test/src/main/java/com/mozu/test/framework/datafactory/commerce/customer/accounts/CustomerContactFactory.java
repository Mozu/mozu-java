...
public class CustomerContactFactory
{
	...
	public static java.io.InputStream deleteAccountContact(ApiContext apiContext, Integer accountId, Integer contactId, int expectedCode) throws Exception
	{
		java.io.InputStream returnObj;
		CustomerContactResource resource = new CustomerContactResource(apiContext);
		try
		{
			returnObj = resource.deleteAccountContact( accountId,  contactId);
		}
		catch (ApiException e)
		{
			if(e.getHttpStatusCode() != expectedCode)
