...
public class DestinationFactory
{
	...
	{
		return addDestination(apiContext,  destination,  checkoutId,  null,  null, expectedCode);
	}

	public static com.mozu.api.contracts.commerceruntime.fulfillment.Destination addDestination(ApiContext apiContext, com.mozu.api.contracts.commerceruntime.fulfillment.Destination destination, String checkoutId, String version, String responseFields, int expectedCode) throws Exception
	{
		com.mozu.api.contracts.commerceruntime.fulfillment.Destination returnObj = new com.mozu.api.contracts.commerceruntime.fulfillment.Destination();
		DestinationResource resource = new DestinationResource(apiContext);
		try
		{
			returnObj = resource.addDestination( destination,  checkoutId,  version,  responseFields);
		}
		catch (ApiException e)
		{
			if(e.getHttpStatusCode() != expectedCode)
	...
	{
		return updateDestination(apiContext,  destination,  checkoutId,  destinationId,  null,  null, expectedCode);
	}

	public static com.mozu.api.contracts.commerceruntime.fulfillment.Destination updateDestination(ApiContext apiContext, com.mozu.api.contracts.commerceruntime.fulfillment.Destination destination, String checkoutId, String destinationId, String version, String responseFields, int expectedCode) throws Exception
	{
		com.mozu.api.contracts.commerceruntime.fulfillment.Destination returnObj = new com.mozu.api.contracts.commerceruntime.fulfillment.Destination();
		DestinationResource resource = new DestinationResource(apiContext);
		try
		{
			returnObj = resource.updateDestination( destination,  checkoutId,  destinationId,  version,  responseFields);
		}
		catch (ApiException e)
		{
			if(e.getHttpStatusCode() != expectedCode)
	...
	{
		removeDestination(apiContext,  checkoutId,  destinationId,  null, expectedCode);
	}

	public static void removeDestination(ApiContext apiContext, String checkoutId, String destinationId, String version, int expectedCode) throws Exception
	{
		DestinationResource resource = new DestinationResource(apiContext);
		try
		{
			resource.removeDestination( checkoutId,  destinationId,  version);
		}
		catch (ApiException e)
		{
			if(e.getHttpStatusCode() != expectedCode)
