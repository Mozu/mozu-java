...
public class ChannelGroupFactory
{
	...
	public static java.io.InputStream deleteChannelGroup(ApiContext apiContext, String code, int expectedCode) throws Exception
	{
		java.io.InputStream returnObj;
		ChannelGroupResource resource = new ChannelGroupResource(apiContext);
		try
		{
			returnObj = resource.deleteChannelGroup( code);
		}
		catch (ApiException e)
		{
			if(e.getHttpStatusCode() != expectedCode)
