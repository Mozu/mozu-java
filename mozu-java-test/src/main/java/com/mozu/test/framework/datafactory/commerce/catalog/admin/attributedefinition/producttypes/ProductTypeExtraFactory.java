...
public class ProductTypeExtraFactory
{
	...
	public static java.io.InputStream deleteExtra(ApiContext apiContext, com.mozu.api.DataViewMode dataViewMode, Integer productTypeId, String attributeFQN, int expectedCode) throws Exception
	{
		java.io.InputStream returnObj;
		ProductTypeExtraResource resource = new ProductTypeExtraResource(apiContext, dataViewMode);
		try
		{
			returnObj = resource.deleteExtra( productTypeId,  attributeFQN);
		}
		catch (ApiException e)
		{
			if(e.getHttpStatusCode() != expectedCode)
