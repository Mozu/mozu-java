...
public class InStockNotificationSubscriptionFactory
{
	...
	public static java.io.InputStream deleteInStockNotificationSubscription(ApiContext apiContext, Integer id, int expectedCode) throws Exception
	{
		java.io.InputStream returnObj;
		InStockNotificationSubscriptionResource resource = new InStockNotificationSubscriptionResource(apiContext);
		try
		{
			returnObj = resource.deleteInStockNotificationSubscription( id);
		}
		catch (ApiException e)
		{
			if(e.getHttpStatusCode() != expectedCode)
