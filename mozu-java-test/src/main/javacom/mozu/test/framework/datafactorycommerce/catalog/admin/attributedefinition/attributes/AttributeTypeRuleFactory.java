...
*/
package com.mozu.test.framework.datafactorycommerce.catalog.admin.attributedefinition.attributes;
...
public class AttributeTypeRuleFactory
{
	...
	public static com.mozu.api.contracts.productadmin.AttributeTypeRuleCollection getAttributeTypeRules(ApiContext apiContext, int expectedCode) throws Exception
	{
		return getAttributeTypeRules(apiContext,  null,  null,  null,  null,  null, expectedCode);
	}

	public static com.mozu.api.contracts.productadmin.AttributeTypeRuleCollection getAttributeTypeRules(ApiContext apiContext, Integer startIndex, Integer pageSize, String sortBy, String filter, String responseFields, int expectedCode) throws Exception
	{
