                    ...
                    <table class=\"ko-grid\" cellspacing=\"0\">\
                        ...
                        <tbody data-bind=\"foreach: itemsOnCurrentPage\">\
                           <tr data-bind=\"foreach: $parent.columns\">\
                                <!-- ko ifnot: $data.hasOwnProperty(\"click\")  -->\
                                        <td data-bind=\"text: typeof rowText == 'function' ? rowText($parent) : $parent[rowText]\"></td>\
                                <!-- /ko -->\
                                <!-- ko if: $data.hasOwnProperty(\"click\") -->\
                                    <td data-bind=\"text: typeof rowText == 'function' ? rowText($parent) : $parent[rowText], click: click.bind($parent) \" class=\"ko-link\"></td>\
                                <!-- /ko -->\
                            </tr>\
                        </tbody>\
                    </table>");
