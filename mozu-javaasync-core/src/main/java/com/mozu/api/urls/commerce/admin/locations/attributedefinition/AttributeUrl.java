 ...
 */
package com.mozu.api.urls.commerce.admin.locations.attributedefinition;
...
public class AttributeUrl
{
	...
	{
		UrlFormatter formatter = new UrlFormatter("/api/commerce/admin/locations/attributedefinition/attributes/?startIndex={startIndex}&pageSize={pageSize}&sortBy={sortBy}&filter={filter}&responseFields={responseFields}");
	...
	{
		UrlFormatter formatter = new UrlFormatter("/api/commerce/admin/locations/attributedefinition/attributes/{attributeFQN}/VocabularyValues");
	...
	{
		UrlFormatter formatter = new UrlFormatter("/api/commerce/admin/locations/attributedefinition/attributes/{attributeFQN}?responseFields={responseFields}");
		formatter.formatUrl("attributeFQN", attributeFQN);
		formatter.formatUrl("responseFields", responseFields);
		return new MozuUrl(formatter.getResourceUrl(), MozuUrl.UrlLocation.TENANT_POD) ;
	}
	...
	{
		UrlFormatter formatter = new UrlFormatter("/api/commerce/admin/locations/attributedefinition/attributes/?responseFields={responseFields}");
		formatter.formatUrl("responseFields", responseFields);
		return new MozuUrl(formatter.getResourceUrl(), MozuUrl.UrlLocation.TENANT_POD) ;
	}
