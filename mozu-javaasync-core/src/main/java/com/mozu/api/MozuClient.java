...
public interface MozuClient<TResult> {
    ...
    public CountDownLatch executeRequest(AsyncCallback<TResult> callback) throws Exception;

    public TResult executePostRequest(Object bodyObject, String resourceUrl, Map<String, String> headers) throws ApiException;

    public CountDownLatch executePostRequest(Object bodyObject, String resourceUrl, Map<String, String> headers, AsyncCallback<TResult> callback) throws ApiException;

    public TResult executePutRequest(Object bodyObject, String resourceUrl, Map<String, String> headers) throws ApiException;

    public CountDownLatch executePutRequest(Object bodyObject, String resourceUrl, Map<String, String> headers, AsyncCallback<TResult> callback) throws ApiException;

    public void executeDeleteRequest(String resourceUrl, Map<String, String> headers) throws ApiException;

    public CountDownLatch executeDeleteRequest(String resourceUrl, Map<String, String> headers, AsyncCallback<TResult> callback) throws ApiException;
