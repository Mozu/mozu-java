...
import com.mozu.api.contracts.productadmin.ProductSortDefinition;

/**
 *	Mozu.ProductAdmin.Contracts.ProductSortDefinitionPagedCollection ApiType DOCUMENT_HERE 
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class ProductSortDefinitionPagedCollection implements Serializable
{
	 ...
	 */
	protected List<ProductSortDefinition> items;
	public List<ProductSortDefinition> getItems() {
		return this.items;
	}
	public void setItems(List<ProductSortDefinition> items) {
		this.items = items;
	}
