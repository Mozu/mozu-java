...
import com.mozu.api.contracts.customer.credit.CreditAuditEntry;

/**
 *	Paged list of audit entries associated with a customer's store credit or gift card.
 */
@JsonIgnoreProperties(ignoreUnknown = true)
public class CreditAuditEntryCollection implements Serializable
{
	 ...
	 */
	protected List<CreditAuditEntry> items;
	public List<CreditAuditEntry> getItems() {
		return this.items;
	}
	public void setItems(List<CreditAuditEntry> items) {
		this.items = items;
	}
