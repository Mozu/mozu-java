...
public class FacetResource {
	 ...
	 * <p><pre><code>
	 *	Facet facet = new Facet();
	 *	CountDownLatch latch = facet.getFacet( facetId, callback );
	 ...
	 * @see com.mozu.api.contracts.productadmin.Facet
	 */
	public CountDownLatch getFacetAsync(Integer facetId, AsyncCallback<com.mozu.api.contracts.productadmin.Facet> callback) throws Exception
	{
		return getFacetAsync( facetId,  null,  null, callback);
	}
	 ...
	 * <p><pre><code>
	 *	Facet facet = new Facet();
	 *	CountDownLatch latch = facet.getFacet( facetId,  validate,  responseFields, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param facetId Unique identifier of the facet to retrieve.
	 * @param responseFields 
	 * @param validate Validates that the product category associated with a facet is active. System-supplied and read only.
	 ...
	 * @see com.mozu.api.contracts.productadmin.Facet
	 */
	public CountDownLatch getFacetAsync(Integer facetId, Boolean validate, String responseFields, AsyncCallback<com.mozu.api.contracts.productadmin.Facet> callback) throws Exception
	{
		MozuClient<com.mozu.api.contracts.productadmin.Facet> client = com.mozu.api.clients.commerce.catalog.admin.FacetClient.getFacetClient( facetId,  validate,  responseFields);
		client.setContext(_apiContext);
	 ...
	 * @see com.mozu.api.contracts.productadmin.Facet
	 */
	public CountDownLatch addFacetAsync(com.mozu.api.contracts.productadmin.Facet facet, AsyncCallback<com.mozu.api.contracts.productadmin.Facet> callback) throws Exception
	{
		return addFacetAsync( facet,  null, callback);
	}
	 ...
	 * <p><pre><code>
	 *	Facet facet = new Facet();
	 *	CountDownLatch latch = facet.addFacet( facet,  responseFields, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param responseFields 
	 * @param  callback callback handler for asynchronous operations
	 * @param facet Properties of the new facet to create. You must specify the source, type, and category.
	 ...
	 * @see com.mozu.api.contracts.productadmin.Facet
	 */
	public CountDownLatch addFacetAsync(com.mozu.api.contracts.productadmin.Facet facet, String responseFields, AsyncCallback<com.mozu.api.contracts.productadmin.Facet> callback) throws Exception
	{
		MozuClient<com.mozu.api.contracts.productadmin.Facet> client = com.mozu.api.clients.commerce.catalog.admin.FacetClient.addFacetClient( facet,  responseFields);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
	 ...
	 * @see com.mozu.api.contracts.productadmin.Facet
	 */
	public CountDownLatch updateFacetAsync(com.mozu.api.contracts.productadmin.Facet facet, Integer facetId, AsyncCallback<com.mozu.api.contracts.productadmin.Facet> callback) throws Exception
	{
		return updateFacetAsync( facet,  facetId,  null, callback);
	}
	 ...
	 * @see com.mozu.api.contracts.productadmin.Facet
	 */
	public CountDownLatch updateFacetAsync(com.mozu.api.contracts.productadmin.Facet facet, Integer facetId, String responseFields, AsyncCallback<com.mozu.api.contracts.productadmin.Facet> callback) throws Exception
	{
		MozuClient<com.mozu.api.contracts.productadmin.Facet> client = com.mozu.api.clients.commerce.catalog.admin.FacetClient.updateFacetClient( facet,  facetId,  responseFields);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
	 ...
	 * <p><pre><code>
	 *	Facet facet = new Facet();
	 *	CountDownLatch latch = facet.deleteFacetById( facetId, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param facetId Unique identifier of the facet to delete.
	 * @param  callback callback handler for asynchronous operations
	 * @return Stream
	 * @see Stream
	 */
	public CountDownLatch deleteFacetByIdAsync(Integer facetId, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.catalog.admin.FacetClient.deleteFacetByIdClient( facetId);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
