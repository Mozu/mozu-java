...
public class DocumentDraftSummaryResource {
	 ...
	 * <p><pre><code>
	 *	DocumentDraftSummary documentdraftsummary = new DocumentDraftSummary();
	 *	CountDownLatch latch = documentdraftsummary.deleteDocumentDrafts( documentIds, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param  callback callback handler for asynchronous operations
	 * @param documentIds Unique identifiers of the documents to delete.
	 * @return Stream
	 ...
	 * @see string
	 */
	public CountDownLatch deleteDocumentDraftsAsync(List<String> documentIds, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		return deleteDocumentDraftsAsync( documentIds,  null, callback);
	}
	 ...
	 * <p><pre><code>
	 *	DocumentDraftSummary documentdraftsummary = new DocumentDraftSummary();
	 *	CountDownLatch latch = documentdraftsummary.deleteDocumentDrafts( documentIds,  documentLists, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param documentLists List of document lists that contain documents to delete.
	 * @param  callback callback handler for asynchronous operations
	 * @param documentIds Unique identifiers of the documents to delete.
	 ...
	 * @see string
	 */
	public CountDownLatch deleteDocumentDraftsAsync(List<String> documentIds, String documentLists, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.content.DocumentDraftSummaryClient.deleteDocumentDraftsClient( documentIds,  documentLists);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
	 ...
	 * <p><pre><code>
	 *	DocumentDraftSummary documentdraftsummary = new DocumentDraftSummary();
	 *	CountDownLatch latch = documentdraftsummary.publishDocuments( documentIds, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param  callback callback handler for asynchronous operations
	 * @param documentIds List of unique identifiers of the document drafts to publish.
	 * @return Stream
	 ...
	 * @see string
	 */
	public CountDownLatch publishDocumentsAsync(List<String> documentIds, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		return publishDocumentsAsync( documentIds,  null, callback);
	}
	 ...
	 * <p><pre><code>
	 *	DocumentDraftSummary documentdraftsummary = new DocumentDraftSummary();
	 *	CountDownLatch latch = documentdraftsummary.publishDocuments( documentIds,  documentLists, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param documentLists List of document lists that contain documents to publish.
	 * @param  callback callback handler for asynchronous operations
	 * @param documentIds List of unique identifiers of the document drafts to publish.
	 ...
	 * @see string
	 */
	public CountDownLatch publishDocumentsAsync(List<String> documentIds, String documentLists, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.content.DocumentDraftSummaryClient.publishDocumentsClient( documentIds,  documentLists);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
