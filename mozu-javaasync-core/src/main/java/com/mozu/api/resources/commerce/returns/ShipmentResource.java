...
public class ShipmentResource {
	 ...
	 * <p><pre><code>
	 *	Shipment shipment = new Shipment();
	 *	Stream stream = shipment.deleteShipment( returnId,  shipmentId);
	 * </code></pre></p>
	 ...
	 * @see Stream
	 */
	public java.io.InputStream deleteShipment(String returnId, String shipmentId) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.returns.ShipmentClient.deleteShipmentClient( returnId,  shipmentId);
		client.setContext(_apiContext);
		client.executeRequest();
		return client.getResult();
	 ...
	 * <p><pre><code>
	 *	Shipment shipment = new Shipment();
	 *	CountDownLatch latch = shipment.deleteShipment( returnId,  shipmentId, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param returnId Unique identifier of the return associated with the replacement shipment to delete.
	 * @param shipmentId Unique identifier of the return replacement shipment to delete.
	 * @param  callback callback handler for asynchronous operations
	 ...
	 * @see Stream
	 */
	public CountDownLatch deleteShipmentAsync(String returnId, String shipmentId, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.returns.ShipmentClient.deleteShipmentClient( returnId,  shipmentId);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
