...
public class ProductTypeExtraResource {
	 ...
	 * <p><pre><code>
	 *	ProductTypeExtra producttypeextra = new ProductTypeExtra();
	 *	CountDownLatch latch = producttypeextra.deleteExtra( productTypeId,  attributeFQN, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param attributeFQN 
	 * @param productTypeId Identifier of the product type.
	 * @param  callback callback handler for asynchronous operations
	 ...
	 * @see Stream
	 */
	public CountDownLatch deleteExtraAsync(Integer productTypeId, String attributeFQN, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.catalog.admin.attributedefinition.producttypes.ProductTypeExtraClient.deleteExtraClient(_dataViewMode,  productTypeId,  attributeFQN);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
