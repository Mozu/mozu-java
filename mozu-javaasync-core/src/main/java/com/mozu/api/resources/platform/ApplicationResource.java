...
public ApplicationResource(ApiContext apiContext) 
	 ...
	 * @see com.mozu.api.contracts.appdev.FileMetadata
	 */
	public CountDownLatch upsertPackageFileAsync(String applicationKey, String filepath, AsyncCallback<com.mozu.api.contracts.appdev.FileMetadata> callback) throws Exception
	{
		return upsertPackageFileAsync( applicationKey,  filepath,  null,  null, callback);
	}
	 ...
	 * @see com.mozu.api.contracts.appdev.FileMetadata
	 */
	public CountDownLatch upsertPackageFileAsync(String applicationKey, String filepath, String lastModifiedTime, String responseFields, AsyncCallback<com.mozu.api.contracts.appdev.FileMetadata> callback) throws Exception
	{
		MozuClient<com.mozu.api.contracts.appdev.FileMetadata> client = com.mozu.api.clients.platform.ApplicationClient.upsertPackageFileClient( applicationKey,  filepath,  lastModifiedTime,  responseFields);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
	 ...
	 * @see Stream
	 */
	public CountDownLatch deletePackageFileAsync(String applicationKey, String filepath, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.platform.ApplicationClient.deletePackageFileClient( applicationKey,  filepath);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
