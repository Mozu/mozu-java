...
public class PropertyTypeResource {
	 ...
	 * @see Stream
	 */
	public java.io.InputStream deletePropertyType(String propertyTypeName) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.content.PropertyTypeClient.deletePropertyTypeClient(_dataViewMode,  propertyTypeName);
		client.setContext(_apiContext);
		client.executeRequest();
		return client.getResult();
	 ...
	 * @see Stream
	 */
	public CountDownLatch deletePropertyTypeAsync(String propertyTypeName, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.content.PropertyTypeClient.deletePropertyTypeClient(_dataViewMode,  propertyTypeName);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
