...
public FileResource(ApiContext apiContext) 
	{
	 ...
	 * <p><pre><code>
	 *	File file = new File();
	 *	Stream stream = file.getFile( applicationKey,  fileName);
	 * </code></pre></p>
	...
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.platform.appdev.FileClient.getFileClient( applicationKey,  fileName);
	 ...
	 * <p><pre><code>
	 *	File file = new File();
	 *	CountDownLatch latch = file.getFile( applicationKey,  fileName, callback );
