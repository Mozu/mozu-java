...
public class TargetRuleResource {
	 ...
	 * <p><pre><code>
	 *	TargetRule targetrule = new TargetRule();
	 *	CountDownLatch latch = targetrule.validateTargetRule( targetRule, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param  callback callback handler for asynchronous operations
	 * @param dataViewMode DataViewMode
	 * @param targetRule The details of the target rule you want to validate.
	 ...
	 * @see com.mozu.api.contracts.shippingadmin.TargetRule
	 */
	public CountDownLatch validateTargetRuleAsync(com.mozu.api.contracts.shippingadmin.TargetRule targetRule, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.TargetRuleClient.validateTargetRuleClient( targetRule);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
	 ...
	 * <p><pre><code>
	 *	TargetRule targetrule = new TargetRule();
	 *	CountDownLatch latch = targetrule.deleteTargetRule( code, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param code User-defined code that uniqely identifies the channel group.
	 * @param  callback callback handler for asynchronous operations
	 * @param dataViewMode DataViewMode
	 ...
	 * @see Stream
	 */
	public CountDownLatch deleteTargetRuleAsync(String code, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.TargetRuleClient.deleteTargetRuleClient( code);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
