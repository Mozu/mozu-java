...
public class SoftAllocationResource {
	 ...
	 * <p><pre><code>
	 *	SoftAllocation softallocation = new SoftAllocation();
	 *	Stream stream = softallocation.deleteSoftAllocation( softAllocationId);
	 * </code></pre></p>
	 * @param softAllocationId 
	 * @param dataViewMode DataViewMode
	 * @return Stream
	 * @see Stream
	 */
	public java.io.InputStream deleteSoftAllocation(Integer softAllocationId) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.catalog.admin.SoftAllocationClient.deleteSoftAllocationClient( softAllocationId);
		client.setContext(_apiContext);
		client.executeRequest();
		return client.getResult();
	 ...
	 * <p><pre><code>
	 *	SoftAllocation softallocation = new SoftAllocation();
	 *	CountDownLatch latch = softallocation.deleteSoftAllocation( softAllocationId, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param softAllocationId 
	 * @param  callback callback handler for asynchronous operations
	 * @param dataViewMode DataViewMode
	 ...
	 * @see Stream
	 */
	public CountDownLatch deleteSoftAllocationAsync(Integer softAllocationId, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.catalog.admin.SoftAllocationClient.deleteSoftAllocationClient( softAllocationId);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
