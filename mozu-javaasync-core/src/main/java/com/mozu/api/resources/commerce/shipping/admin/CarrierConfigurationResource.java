...
public class CarrierConfigurationResource {
	 ...
	 * <p><pre><code>
	 *	CarrierConfiguration carrierconfiguration = new CarrierConfiguration();
	 *	CountDownLatch latch = carrierconfiguration.deleteConfiguration( carrierId, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param carrierId The unique identifier of the carrier configuration.
	 * @param  callback callback handler for asynchronous operations
	 * @return Stream
	 * @see Stream
	 */
	public CountDownLatch deleteConfigurationAsync(String carrierId, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.shipping.admin.CarrierConfigurationClient.deleteConfigurationClient( carrierId);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
