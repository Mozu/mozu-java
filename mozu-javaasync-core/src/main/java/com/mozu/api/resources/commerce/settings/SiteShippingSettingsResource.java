...
public class SiteShippingSettingsResource {
	 ...
	 * @see com.mozu.api.contracts.sitesettings.shipping.SiteShippingSettings
	 */
	public CountDownLatch getSiteShippingSettingsAsync( AsyncCallback<com.mozu.api.contracts.sitesettings.shipping.SiteShippingSettings> callback) throws Exception
	{
		return getSiteShippingSettingsAsync( null, callback);
	}
	 ...
	 * @see com.mozu.api.contracts.sitesettings.shipping.SiteShippingSettings
	 */
	public CountDownLatch getSiteShippingSettingsAsync(String responseFields, AsyncCallback<com.mozu.api.contracts.sitesettings.shipping.SiteShippingSettings> callback) throws Exception
	{
		MozuClient<com.mozu.api.contracts.sitesettings.shipping.SiteShippingSettings> client = com.mozu.api.clients.commerce.settings.SiteShippingSettingsClient.getSiteShippingSettingsClient( responseFields);
		client.setContext(_apiContext);
