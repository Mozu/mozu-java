...
public class EntityResource {
	 ...
	 * <p><pre><code>
	 *	Entity entity = new Entity();
	 *	CountDownLatch latch = entity.deleteEntity( entityListFullName,  id, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param entityListFullName 
	 * @param id 
	 * @param  callback callback handler for asynchronous operations
	 ...
	 * @see Stream
	 */
	public CountDownLatch deleteEntityAsync(String entityListFullName, String id, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.platform.entitylists.EntityClient.deleteEntityClient( entityListFullName,  id);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
