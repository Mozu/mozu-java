...
public class PaymentResource {
	 ...
	 * <p><pre><code>
	 *	Payment payment = new Payment();
	 *	CountDownLatch latch = payment.autoCapturePayments( orderId, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param orderId 
	 * @param  callback callback handler for asynchronous operations
	 * @return com.mozu.api.contracts.commerceruntime.orders.Order
	 * @see com.mozu.api.contracts.commerceruntime.orders.Order
	 */
	public CountDownLatch autoCapturePaymentsAsync(String orderId, AsyncCallback<com.mozu.api.contracts.commerceruntime.orders.Order> callback) throws Exception
	{
		return autoCapturePaymentsAsync( orderId,  null,  null, callback);
	}
	 ...
	 * <p><pre><code>
	 *	Payment payment = new Payment();
	 *	CountDownLatch latch = payment.autoCapturePayments( orderId,  forceCapture,  responseFields, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param forceCapture 
	 * @param orderId 
	 * @param responseFields 
	 ...
	 * @see com.mozu.api.contracts.commerceruntime.orders.Order
	 */
	public CountDownLatch autoCapturePaymentsAsync(String orderId, Boolean forceCapture, String responseFields, AsyncCallback<com.mozu.api.contracts.commerceruntime.orders.Order> callback) throws Exception
	{
		MozuClient<com.mozu.api.contracts.commerceruntime.orders.Order> client = com.mozu.api.clients.commerce.orders.PaymentClient.autoCapturePaymentsClient( orderId,  forceCapture,  responseFields);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
