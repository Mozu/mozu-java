...
public class LocationInventoryResource {
	 ...
	 * <p><pre><code>
	 *	LocationInventory locationinventory = new LocationInventory();
	 *	Stream stream = locationinventory.deleteLocationInventory( productCode,  locationCode);
	 * </code></pre></p>
	 ...
	 * @see Stream
	 */
	public java.io.InputStream deleteLocationInventory(String productCode, String locationCode) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.catalog.admin.products.LocationInventoryClient.deleteLocationInventoryClient(_dataViewMode,  productCode,  locationCode);
		client.setContext(_apiContext);
		client.executeRequest();
		return client.getResult();
	 ...
	 * <p><pre><code>
	 *	LocationInventory locationinventory = new LocationInventory();
	 *	CountDownLatch latch = locationinventory.deleteLocationInventory( productCode,  locationCode, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param locationCode The code that identifies the location for which to delete product inventory.
	 * @param productCode The product code for which to delete a location's inventory.
	 * @param  callback callback handler for asynchronous operations
	 ...
	 * @see Stream
	 */
	public CountDownLatch deleteLocationInventoryAsync(String productCode, String locationCode, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.catalog.admin.products.LocationInventoryClient.deleteLocationInventoryClient(_dataViewMode,  productCode,  locationCode);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
