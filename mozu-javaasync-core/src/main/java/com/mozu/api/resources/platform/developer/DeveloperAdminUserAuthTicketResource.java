...
public DeveloperAdminUserAuthTicketResource(ApiContext apiContext) 
	 ...
	 * <p><pre><code>
	 *	DeveloperAdminUserAuthTicket developeradminuserauthticket = new DeveloperAdminUserAuthTicket();
	 *	CountDownLatch latch = developeradminuserauthticket.createDeveloperUserAuthTicket( userAuthInfo, callback );
	 ...
	 * @see com.mozu.api.contracts.core.UserAuthInfo
	 */
	public CountDownLatch createDeveloperUserAuthTicketAsync(com.mozu.api.contracts.core.UserAuthInfo userAuthInfo, AsyncCallback<com.mozu.api.contracts.adminuser.DeveloperAdminUserAuthTicket> callback) throws Exception
	{
		return createDeveloperUserAuthTicketAsync( userAuthInfo,  null,  null, callback);
	}
	 ...
	 * <p><pre><code>
	 *	DeveloperAdminUserAuthTicket developeradminuserauthticket = new DeveloperAdminUserAuthTicket();
	 *	CountDownLatch latch = developeradminuserauthticket.createDeveloperUserAuthTicket( userAuthInfo,  developerAccountId,  responseFields, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param developerAccountId Unique identifier of the developer account.
	 * @param responseFields Filtering syntax appended to an API call to increase or decrease the amount of data returned inside a JSON object. This parameter should only be used to retrieve data. Attempting to update data using this parameter may cause data loss.
	 * @param  callback callback handler for asynchronous operations
	 ...
	 * @see com.mozu.api.contracts.core.UserAuthInfo
	 */
	public CountDownLatch createDeveloperUserAuthTicketAsync(com.mozu.api.contracts.core.UserAuthInfo userAuthInfo, Integer developerAccountId, String responseFields, AsyncCallback<com.mozu.api.contracts.adminuser.DeveloperAdminUserAuthTicket> callback) throws Exception
	{
		MozuClient<com.mozu.api.contracts.adminuser.DeveloperAdminUserAuthTicket> client = com.mozu.api.clients.platform.developer.DeveloperAdminUserAuthTicketClient.createDeveloperUserAuthTicketClient( userAuthInfo,  developerAccountId,  responseFields);
		client.setContext(_apiContext);
	 ...
	 * <p><pre><code>
	 *	DeveloperAdminUserAuthTicket developeradminuserauthticket = new DeveloperAdminUserAuthTicket();
	 *	CountDownLatch latch = developeradminuserauthticket.refreshDeveloperAuthTicket( existingAuthTicket, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param  callback callback handler for asynchronous operations
	 * @param existingAuthTicket Properties of the authentication ticket to be used in developer account claims with the  API.
	 * @return com.mozu.api.contracts.adminuser.DeveloperAdminUserAuthTicket
	 ...
	 * @see com.mozu.api.contracts.adminuser.DeveloperAdminUserAuthTicket
	 */
	public CountDownLatch refreshDeveloperAuthTicketAsync(com.mozu.api.contracts.adminuser.DeveloperAdminUserAuthTicket existingAuthTicket, AsyncCallback<com.mozu.api.contracts.adminuser.DeveloperAdminUserAuthTicket> callback) throws Exception
	{
		return refreshDeveloperAuthTicketAsync( existingAuthTicket,  null,  null, callback);
	}
	 ...
	 * <p><pre><code>
	 *	DeveloperAdminUserAuthTicket developeradminuserauthticket = new DeveloperAdminUserAuthTicket();
	 *	CountDownLatch latch = developeradminuserauthticket.refreshDeveloperAuthTicket( existingAuthTicket,  developerAccountId,  responseFields, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param developerAccountId Unique identifier of the developer account.
	 * @param responseFields Filtering syntax appended to an API call to increase or decrease the amount of data returned inside a JSON object. This parameter should only be used to retrieve data. Attempting to update data using this parameter may cause data loss.
	 * @param  callback callback handler for asynchronous operations
	 ...
	 * @see com.mozu.api.contracts.adminuser.DeveloperAdminUserAuthTicket
	 */
	public CountDownLatch refreshDeveloperAuthTicketAsync(com.mozu.api.contracts.adminuser.DeveloperAdminUserAuthTicket existingAuthTicket, Integer developerAccountId, String responseFields, AsyncCallback<com.mozu.api.contracts.adminuser.DeveloperAdminUserAuthTicket> callback) throws Exception
	{
		MozuClient<com.mozu.api.contracts.adminuser.DeveloperAdminUserAuthTicket> client = com.mozu.api.clients.platform.developer.DeveloperAdminUserAuthTicketClient.refreshDeveloperAuthTicketClient( existingAuthTicket,  developerAccountId,  responseFields);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
	 ...
	 * <p><pre><code>
	 *	DeveloperAdminUserAuthTicket developeradminuserauthticket = new DeveloperAdminUserAuthTicket();
	 *	Stream stream = developeradminuserauthticket.deleteUserAuthTicket( refreshToken);
	 * </code></pre></p>
	...
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.platform.developer.DeveloperAdminUserAuthTicketClient.deleteUserAuthTicketClient( refreshToken);
		client.setContext(_apiContext);
		client.executeRequest();
		return client.getResult();
	 ...
	 * <p><pre><code>
	 *	DeveloperAdminUserAuthTicket developeradminuserauthticket = new DeveloperAdminUserAuthTicket();
	 *	CountDownLatch latch = developeradminuserauthticket.deleteUserAuthTicket( refreshToken, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param refreshToken Alphanumeric string used for access tokens. This token refreshes access for accounts by generating a new developer or application account authentication ticket after an access token expires.
	 * @param  callback callback handler for asynchronous operations
	 * @return Stream
	 * @see Stream
	 */
	public CountDownLatch deleteUserAuthTicketAsync(String refreshToken, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.platform.developer.DeveloperAdminUserAuthTicketClient.deleteUserAuthTicketClient( refreshToken);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
