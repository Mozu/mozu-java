...
public class CheckoutResource {
	...
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.CheckoutClient.resendCheckoutConfirmationEmailClient( checkoutId);
		client.setContext(_apiContext);
		client.executeRequest();
		return client.getResult();
	 ...
	 * <p><pre><code>
	 *	Checkout checkout = new Checkout();
	 *	CountDownLatch latch = checkout.resendCheckoutConfirmationEmail( checkoutId, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param checkoutId The unique identifier of the checkout.
	 * @param  callback callback handler for asynchronous operations
	 * @return Stream
	 * @see Stream
	 */
	public CountDownLatch resendCheckoutConfirmationEmailAsync(String checkoutId, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.CheckoutClient.resendCheckoutConfirmationEmailClient( checkoutId);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
