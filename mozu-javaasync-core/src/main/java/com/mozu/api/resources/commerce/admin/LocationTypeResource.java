...
public class LocationTypeResource {
	 ...
	 * <p><pre><code>
	 *	LocationType locationtype = new LocationType();
	 *	CountDownLatch latch = locationtype.deleteLocationType( locationTypeCode, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param locationTypeCode User-defined code used to identify the location type.
	 * @param  callback callback handler for asynchronous operations
	 * @return Stream
	 * @see Stream
	 */
	public CountDownLatch deleteLocationTypeAsync(String locationTypeCode, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.admin.LocationTypeClient.deleteLocationTypeClient( locationTypeCode);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
