...
public class AttributeLocalizedContentResource {
	 ...
	 * <p><pre><code>
	 *	AttributeLocalizedContent attributelocalizedcontent = new AttributeLocalizedContent();
	 *	Stream stream = attributelocalizedcontent.deleteLocalizedContent( attributeFQN,  localeCode);
	 * </code></pre></p>
	 * @param attributeFQN 
	 * @param localeCode 
	 * @param dataViewMode DataViewMode
	 ...
	 * @see Stream
	 */
	public java.io.InputStream deleteLocalizedContent(String attributeFQN, String localeCode) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.catalog.admin.attributedefinition.attributes.AttributeLocalizedContentClient.deleteLocalizedContentClient( attributeFQN,  localeCode);
		client.setContext(_apiContext);
		client.executeRequest();
		return client.getResult();
	 ...
	 * <p><pre><code>
	 *	AttributeLocalizedContent attributelocalizedcontent = new AttributeLocalizedContent();
	 *	CountDownLatch latch = attributelocalizedcontent.deleteLocalizedContent( attributeFQN,  localeCode, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param attributeFQN 
	 * @param localeCode 
	 * @param  callback callback handler for asynchronous operations
	 ...
	 * @see Stream
	 */
	public CountDownLatch deleteLocalizedContentAsync(String attributeFQN, String localeCode, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.catalog.admin.attributedefinition.attributes.AttributeLocalizedContentClient.deleteLocalizedContentClient( attributeFQN,  localeCode);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
