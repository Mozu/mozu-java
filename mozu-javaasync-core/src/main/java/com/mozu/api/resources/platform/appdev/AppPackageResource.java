...
public class AppPackageResource {
	 ...
	 * <p><pre><code>
	 *	AppPackage apppackage = new AppPackage();
	 *	Stream stream = apppackage.deletePackage( applicationKey);
	 * </code></pre></p>
	 * @param applicationKey 
	 * @return Stream
	 * @see Stream
	 */
	public java.io.InputStream deletePackage(String applicationKey) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.platform.appdev.AppPackageClient.deletePackageClient( applicationKey);
		client.setContext(_apiContext);
		client.executeRequest();
		return client.getResult();
	 ...
	 * <p><pre><code>
	 *	AppPackage apppackage = new AppPackage();
	 *	CountDownLatch latch = apppackage.deletePackage( applicationKey, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param applicationKey 
	 * @param  callback callback handler for asynchronous operations
	 * @return Stream
	 * @see Stream
	 */
	public CountDownLatch deletePackageAsync(String applicationKey, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.platform.appdev.AppPackageClient.deletePackageClient( applicationKey);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
