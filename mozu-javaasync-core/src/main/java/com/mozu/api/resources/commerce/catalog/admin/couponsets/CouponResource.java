...
public class CouponResource {
	 ...
	 * <p><pre><code>
	 *	Coupon coupon = new Coupon();
	 *	CountDownLatch latch = coupon.addCoupons( coupons,  couponSetCode, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param couponSetCode 
	 * @param  callback callback handler for asynchronous operations
	 * @param coupons 
	 ...
	 * @see com.mozu.api.contracts.productadmin.Coupon
	 */
	public CountDownLatch addCouponsAsync(List<com.mozu.api.contracts.productadmin.Coupon> coupons, String couponSetCode, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.catalog.admin.couponsets.CouponClient.addCouponsClient( coupons,  couponSetCode);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
	 ...
	 * <p><pre><code>
	 *	Coupon coupon = new Coupon();
	 *	CountDownLatch latch = coupon.deleteCoupons( couponCodes,  couponSetCode, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param couponSetCode 
	 * @param  callback callback handler for asynchronous operations
	 * @param couponCodes 
	 ...
	 * @see string
	 */
	public CountDownLatch deleteCouponsAsync(List<String> couponCodes, String couponSetCode, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.catalog.admin.couponsets.CouponClient.deleteCouponsClient( couponCodes,  couponSetCode);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
	 ...
	 * <p><pre><code>
	 *	Coupon coupon = new Coupon();
	 *	CountDownLatch latch = coupon.deleteCoupon( couponSetCode,  couponCode, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param couponCode 
	 * @param couponSetCode 
	 * @param  callback callback handler for asynchronous operations
	 ...
	 * @see Stream
	 */
	public CountDownLatch deleteCouponAsync(String couponSetCode, String couponCode, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.catalog.admin.couponsets.CouponClient.deleteCouponClient( couponSetCode,  couponCode);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
