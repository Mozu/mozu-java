...
public class ProductVariationResource {
	 ...
	 * <p><pre><code>
	 *	ProductVariation productvariation = new ProductVariation();
	 *	Stream stream = productvariation.deleteProductVariation( productCode,  variationKey);
	 * </code></pre></p>
	 * @param productCode 
	 * @param variationKey System-generated key that represents the attribute values that uniquely identify a specific product variation.
	 * @return Stream
	 * @see Stream
	 */
	public java.io.InputStream deleteProductVariation(String productCode, String variationKey) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.catalog.admin.products.ProductVariationClient.deleteProductVariationClient(_dataViewMode,  productCode,  variationKey);
		client.setContext(_apiContext);
		client.executeRequest();
		return client.getResult();
	 ...
	 * <p><pre><code>
	 *	ProductVariation productvariation = new ProductVariation();
	 *	CountDownLatch latch = productvariation.deleteProductVariation( productCode,  variationKey, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param productCode 
	 * @param variationKey System-generated key that represents the attribute values that uniquely identify a specific product variation.
	 * @param  callback callback handler for asynchronous operations
	 ...
	 * @see Stream
	 */
	public CountDownLatch deleteProductVariationAsync(String productCode, String variationKey, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.catalog.admin.products.ProductVariationClient.deleteProductVariationClient(_dataViewMode,  productCode,  variationKey);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
	 ...
	 * <p><pre><code>
	 *	ProductVariation productvariation = new ProductVariation();
	 *	Stream stream = productvariation.deleteProductVariationLocalizedDeltaPrice( productCode,  variationKey,  currencyCode);
	 * </code></pre></p>
	 * @param currencyCode 
	 * @param productCode 
	 * @param variationKey 
	 ...
	 * @see Stream
	 */
	public java.io.InputStream deleteProductVariationLocalizedDeltaPrice(String productCode, String variationKey, String currencyCode) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.catalog.admin.products.ProductVariationClient.deleteProductVariationLocalizedDeltaPriceClient(_dataViewMode,  productCode,  variationKey,  currencyCode);
		client.setContext(_apiContext);
		client.executeRequest();
		return client.getResult();
	 ...
	 * <p><pre><code>
	 *	ProductVariation productvariation = new ProductVariation();
	 *	CountDownLatch latch = productvariation.deleteProductVariationLocalizedDeltaPrice( productCode,  variationKey,  currencyCode, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param currencyCode 
	 * @param productCode 
	 * @param variationKey 
	 ...
	 * @see Stream
	 */
	public CountDownLatch deleteProductVariationLocalizedDeltaPriceAsync(String productCode, String variationKey, String currencyCode, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.catalog.admin.products.ProductVariationClient.deleteProductVariationLocalizedDeltaPriceClient(_dataViewMode,  productCode,  variationKey,  currencyCode);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
	 ...
	 * <p><pre><code>
	 *	ProductVariation productvariation = new ProductVariation();
	 *	Stream stream = productvariation.deleteProductVariationLocalizedPrice( productCode,  variationKey,  currencyCode);
	 * </code></pre></p>
	 * @param currencyCode 
	 * @param productCode 
	 * @param variationKey 
	 ...
	 * @see Stream
	 */
	public java.io.InputStream deleteProductVariationLocalizedPrice(String productCode, String variationKey, String currencyCode) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.catalog.admin.products.ProductVariationClient.deleteProductVariationLocalizedPriceClient(_dataViewMode,  productCode,  variationKey,  currencyCode);
		client.setContext(_apiContext);
		client.executeRequest();
		return client.getResult();
	 ...
	 * <p><pre><code>
	 *	ProductVariation productvariation = new ProductVariation();
	 *	CountDownLatch latch = productvariation.deleteProductVariationLocalizedPrice( productCode,  variationKey,  currencyCode, callback );
	 *	latch.await()	 * </code></pre></p>
	 * @param currencyCode 
	 * @param productCode 
	 * @param variationKey 
	 ...
	 * @see Stream
	 */
	public CountDownLatch deleteProductVariationLocalizedPriceAsync(String productCode, String variationKey, String currencyCode, AsyncCallback<java.io.InputStream> callback) throws Exception
	{
		MozuClient<java.io.InputStream> client = com.mozu.api.clients.commerce.catalog.admin.products.ProductVariationClient.deleteProductVariationLocalizedPriceClient(_dataViewMode,  productCode,  variationKey,  currencyCode);
		client.setContext(_apiContext);
		return client.executeRequest(callback);
