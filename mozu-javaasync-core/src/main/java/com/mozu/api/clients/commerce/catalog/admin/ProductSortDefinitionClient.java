...
public class ProductSortDefinitionClient {
	 ...
	 * 
	 * <p><pre><code>
	 * MozuClient<java.io.InputStream> mozuClient=DeleteProductSortDefinitionClient(dataViewMode,  productSortDefinitionId);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 ...
	 * @see Stream
	 */
	public static MozuClient<java.io.InputStream> deleteProductSortDefinitionClient(com.mozu.api.DataViewMode dataViewMode, Integer productSortDefinitionId) throws Exception
	{
