...
public class TargetRuleClient {
	 ...
	 * 
	 * <p><pre><code>
	 * MozuClient<java.io.InputStream> mozuClient=ValidateTargetRuleClient( targetRule);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 ...
	 * @see com.mozu.api.contracts.shippingadmin.TargetRule
	 */
	public static MozuClient<java.io.InputStream> validateTargetRuleClient(com.mozu.api.contracts.shippingadmin.TargetRule targetRule) throws Exception
	{
	 ...
	 * 
	 * <p><pre><code>
	 * MozuClient<java.io.InputStream> mozuClient=DeleteTargetRuleClient( code);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 * Stream stream = client.Result();
	 * </code></pre></p>
	 ...
	 * @see Stream
	 */
	public static MozuClient<java.io.InputStream> deleteTargetRuleClient(String code) throws Exception
	{
