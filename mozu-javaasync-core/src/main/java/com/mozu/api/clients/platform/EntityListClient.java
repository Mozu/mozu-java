...
public class EntityListClient {
	 ...
	 * 
	 * <p><pre><code>
	 * MozuClient<java.io.InputStream> mozuClient=DeleteEntityListClient( entityListFullName);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 ...
	 * @see Stream
	 */
	public static MozuClient<java.io.InputStream> deleteEntityListClient(String entityListFullName) throws Exception
	{
