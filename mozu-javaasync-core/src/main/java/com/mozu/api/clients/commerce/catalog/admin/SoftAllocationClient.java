...
public class SoftAllocationClient {
	 ...
	 * 
	 * <p><pre><code>
	 * MozuClient<java.io.InputStream> mozuClient=DeleteSoftAllocationClient( softAllocationId);
	 * client.setBaseAddress(url);
	 * client.executeRequest();
	 ...
	 * @see Stream
	 */
	public static MozuClient<java.io.InputStream> deleteSoftAllocationClient(Integer softAllocationId) throws Exception
	{
