 ...
 */
package com.mozu.api.clients.commerce.customer.accountattributedefinition;
...
public class AttributeClient {
	...
	{
		MozuUrl url = com.mozu.api.urls.commerce.customer.accountattributedefinition.AttributeUrl.getAttributesUrl(filter, pageSize, responseFields, sortBy, startIndex);
		String verb = "GET";
	...
	{
		MozuUrl url = com.mozu.api.urls.commerce.customer.accountattributedefinition.AttributeUrl.getAttributeVocabularyValuesUrl(attributeFQN);
		String verb = "GET";
	...
	{
		MozuUrl url = com.mozu.api.urls.commerce.customer.accountattributedefinition.AttributeUrl.getAttributeUrl(attributeFQN, responseFields);
		String verb = "GET";
	...
	{
		MozuUrl url = com.mozu.api.urls.commerce.customer.accountattributedefinition.AttributeUrl.createAttributeUrl(responseFields);
		String verb = "POST";
		Class<?> clz = com.mozu.api.contracts.core.extensible.Attribute.class;
		MozuClient<com.mozu.api.contracts.core.extensible.Attribute> mozuClient = (MozuClient<com.mozu.api.contracts.core.extensible.Attribute>) MozuClientFactory.getInstance(clz);
		mozuClient.setVerb(verb);
	...
	{
		MozuUrl url = com.mozu.api.urls.commerce.customer.accountattributedefinition.AttributeUrl.updateAttributeUrl(attributeFQN, responseFields);
		String verb = "PUT";
		Class<?> clz = com.mozu.api.contracts.core.extensible.Attribute.class;
		MozuClient<com.mozu.api.contracts.core.extensible.Attribute> mozuClient = (MozuClient<com.mozu.api.contracts.core.extensible.Attribute>) MozuClientFactory.getInstance(clz);
		mozuClient.setVerb(verb);
